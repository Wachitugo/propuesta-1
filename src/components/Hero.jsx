    ...
    return (
        <section id="hero" className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-slate-50">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full overflow-hidden -z-10 pointer-events-none">
                <div className="absolute top-[-10%] left-[-5%] w-[500px] h-[500px] bg-[#34B6D8] rounded-full mix-blend-multiply filter blur-[100px] opacity-20 animate-blob"></div>
                <div className="absolute top-[20%] right-[-5%] w-[500px] h-[500px] bg-[#1A71B8] rounded-full mix-blend-multiply filter blur-[100px] opacity-10 animate-blob animation-delay-2000"></div>
            </div>
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 text-center lg:text-left flex flex-col items-center lg:items-start">
                        ...
                        {/* Animated Badge */}
                        <div className="inline-flex items-center gap-2 bg-[#34B6D8]/10 border border-[#34B6D8]/30 px-4 py-2 rounded-full text-sm font-bold text-[#1A71B8] mb-6 shadow-sm animate-fade-in-up">
                        ...
                        {/* Heading */}
                        <h1 className="mb-6 tracking-tight text-5xl lg:text-6xl font-extrabold leading-[1.1] text-[#0A3866] animate-fade-in-up animation-delay-100 flex flex-col items-center lg:items-start">
                        ...
                        {/* Subtext */}
                        <p className="max-w-xl mb-10 text-lg text-slate-600 leading-relaxed animate-fade-in-up animation-delay-200">
                        ...
                        {/* Trust Indicator */}
                        <div className="mt-8 flex items-center gap-2 text-sm text-slate-500 font-medium animate-fade-in-up animation-delay-400">
                    ...
                    <div className="w-full lg:w-1/2 relative animate-fade-in-up animation-delay-300 mt-12 lg:mt-0">
